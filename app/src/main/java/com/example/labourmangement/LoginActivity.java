...
public class LoginActivity extends AppCompatActivity {
    ...
    Button btnlogin;
    TextView textexistinguser,linkoadminlogin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnlogin = (Button) findViewById(R.id.button_loginapp1);
        textexistinguser = (TextView) findViewById(R.id.textView_new_user);
        edit_name = (EditText) findViewById(R.id.editTextLoginName);
        edit_password = (EditText) findViewById(R.id.editTextLoginpassword);
linkoadminlogin=(TextView)findViewById(R.id.linktoadmin_login);

      /*  linkoadminlogin.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void checkLogin(final String email, final String password) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_LOGINLABOUR, new Response.Listener<String>() {
