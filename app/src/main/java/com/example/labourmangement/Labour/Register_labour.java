...
et_conpassword=(EditText)findViewById(R.id.editTextregisterconfirmpassword11);
        ...
        btnregister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                //  String mobilenum = et_mobilenumber.getText().toString().trim();
    ...
    private void registerUser(final String name, final String email,
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_REGISTERLABOUR, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof TimeoutError || error instanceof NoConnectionError) {
                    ...
                    Toast.makeText(Register_labour.this, "Something wrong11", duration).show();
                    ...
                    pDialog.dismiss();
                    int duration = Toast.LENGTH_SHORT;
                    Toast.makeText(Register_labour.this, "Something wrong22", duration).show();
                } else if (error instanceof ServerError) {
                    System.out.println("server erroer......................." + error);
                    pDialog.dismiss();

                    int duration = Toast.LENGTH_SHORT;
                    Toast.makeText(Register_labour.this, "Something wrong33", duration).show();
                    //TODO
                    ...
                    int duration = Toast.LENGTH_SHORT;
                    Toast.makeText(Register_labour.this, "Something wrong44", duration).show();
                    //TODO
                    ...
                    int duration = Toast.LENGTH_SHORT;
                    Toast.makeText(Register_labour.this, "Something wrong55", duration).show();
                    //TODO
